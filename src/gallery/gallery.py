...
def create_gallery_html():
    ...
    if BatteryHandler.battery_charging.reveal():
        if BatteryHandler.battery_level.reveal()>80:
            html_content += '<img src="icons/battery5c.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>60:
            html_content += '<img src="icons/battery4c.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>40:
            html_content += '<img src="icons/battery3c.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>20:
            html_content += '<img src="icons/battery2c.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>0:
            html_content += '<img src="icons/battery1c.png" alt="Battery">\n'
    
    else:
        if BatteryHandler.battery_level.reveal()>80:
            html_content += '<img src="icons/battery5.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>60:
            html_content += '<img src="icons/battery4.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>40:
            html_content += '<img src="icons/battery3.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>20:
            html_content += '<img src="icons/battery2.png" alt="Battery">\n'
        elif BatteryHandler.battery_level.reveal()>0:
            html_content += '<img src="icons/battery1.png" alt="Battery">\n'
